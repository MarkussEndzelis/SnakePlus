...
public class SkinRegistry {
	...
	public static final SnakeSkin[] ALL = {
			...
			new SnakeSkin("Retro", Color.decode("#ffffff"), Color.decode("#aaaaaa"), Color.decode("#555555"), 100),
			new SnakeSkin("Fire", Color.decode("#ff4500"), Color.decode("#ff8c00"), Color.decode("#ff0000"), 250),
			new SnakeSkin("Ice", Color.decode("#00cfff"), Color.decode("#a8e6ff"), Color.decode("#0080ff"), 250),
			new SnakeSkin("Toxic", Color.decode("#aaff00"), Color.decode("#ccff66"), Color.decode("#669900"), 250),
			new SnakeSkin("Gold", Color.decode("#ffd700"), Color.decode("#ffe88a"), Color.decode("#b8860b"), 500),
